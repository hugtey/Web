...
if (isset($_POST['submit'])) {
    ...
    if (!empty($username) && !empty($fullname) && !empty($password) && !empty($email) && !empty($gender)) {
        ...
        $sql = "INSERT INTO `tbl_users` (`fullname`,`username`,`password`,`email`,`gender`,`rank`,`role`) VALUES ('$fullname','$username','$password','$email','$gender', '$rank','$role') ";
...
?>
<br>
<a href="admin_user.php"> Quay lại trang chủ</a>